...
from utils import get_data, SlidingWindowDataset, create_data_loader, find_epsilon, update_json, specify_args, _acquire_device
...
if __name__ == "__main__":
    ...
    window_size = args.seq_len  # TODO 1. Check that those two match
    ...
    train_dataset = SlidingWindowDataset(x_train, window_size, args.label_len, args.pred_len, stride=args.stride)
